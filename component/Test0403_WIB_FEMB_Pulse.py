...
target_file_path = get_test_subdir("Test0403_FEMB_Slot3_Pulse")
...
for fembi in [3]:
    ...
    if rp_dict.csv_manager:
        rp_dict.csv_manager.batch_update([
            {"item_id": "T04_30", "value": result_dict.get("seoff_test_status", "UNKNOWN"), "status": result_dict.get("seoff_test_status", "UNKNOWN")},
            {"item_id": "T04_31", "value": result_dict.get("seon_test_status",  "UNKNOWN"), "status": result_dict.get("seon_test_status",  "UNKNOWN")},
            {"item_id": "T04_32", "value": result_dict.get("diff_test_status",  "UNKNOWN"), "status": result_dict.get("diff_test_status",  "UNKNOWN")},
            {"item_id": "T04_33", "value": result_dict.get("data_acq_status",   "UNKNOWN"), "status": result_dict.get("data_acq_status",   "UNKNOWN")},
        ])
