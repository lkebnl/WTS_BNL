...
for fembi in [1]:
    ...
    if rp_dict.csv_manager:
        rp_dict.csv_manager.batch_update([
            {"item_id": "T04_10", "value": result_dict.get("seoff_test_status", "UNKNOWN"), "status": result_dict.get("seoff_test_status", "UNKNOWN")},
            {"item_id": "T04_11", "value": result_dict.get("seon_test_status",  "UNKNOWN"), "status": result_dict.get("seon_test_status",  "UNKNOWN")},
            {"item_id": "T04_12", "value": result_dict.get("diff_test_status",  "UNKNOWN"), "status": result_dict.get("diff_test_status",  "UNKNOWN")},
            {"item_id": "T04_13", "value": result_dict.get("data_acq_status",   "UNKNOWN"), "status": result_dict.get("data_acq_status",   "UNKNOWN")},
        ])
