...
print_header("A_RT03_03 : FEMB Power Rail Test (3V)")
...
report_filename = get_report_filename("Test03_3V_power_report", all_passed)
...
# TEST SUMMARY
# ============================================================================
print_header("Test03: FEMB Power Rail Test (3V) - SUMMARY")
...
print("=" * 60)
print(f"  FEMB Power Rail Test (3V) - {overall_status}")
...
psu.safe_power_off()
psu.close()
print_pass("Test03 (3V) completed successfully!")
