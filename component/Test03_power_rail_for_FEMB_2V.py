...
print_header("A_RT03_02 : FEMB Power Rail Test (2V)")
...
if rp_dict.csv_manager:
    ...
    rp_dict.csv_manager.batch_update([
        ...
        {"item_id": "T03_2V_01", "value": round(c1_wib, 3), "status": total_c_status},
        {"item_id": "T03_2V_02", "value": round(v2_wib, 3), "status": v2_status},
        {"item_id": "T03_2V_03", "value": round(c2_wib, 3), "status": total_c_status}
    ])
...
report_filename = get_report_filename("Test03_2V_power_report", all_passed)
...
# TEST SUMMARY
# ============================================================================
print_header("Test03: FEMB Power Rail Test (2V) - SUMMARY")
...
print("=" * 60)
print(f"  FEMB Power Rail Test (2V) - {overall_status}")
...
psu.safe_power_off()
psu.close()
print_pass("Test03 (2V) completed successfully!")
