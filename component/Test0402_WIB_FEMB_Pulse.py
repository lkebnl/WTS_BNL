...
for fembi in [2]:
    ...
    if rp_dict.csv_manager:
        rp_dict.csv_manager.batch_update([
            {"item_id": "T04_20", "value": result_dict.get("seoff_test_status", "UNKNOWN"), "status": result_dict.get("seoff_test_status", "UNKNOWN")},
            {"item_id": "T04_21", "value": result_dict.get("seon_test_status",  "UNKNOWN"), "status": result_dict.get("seon_test_status",  "UNKNOWN")},
            {"item_id": "T04_22", "value": result_dict.get("diff_test_status",  "UNKNOWN"), "status": result_dict.get("diff_test_status",  "UNKNOWN")},
            {"item_id": "T04_23", "value": result_dict.get("data_acq_status",   "UNKNOWN"), "status": result_dict.get("data_acq_status",   "UNKNOWN")},
        ])
