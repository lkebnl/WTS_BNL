...
if rp_dict.csv_manager:
    ...
    rp_dict.csv_manager.batch_update([
        ...
        {"item_id": "T03_4V_01", "value": round(c1_wib, 3), "status": total_c_status},
        {"item_id": "T03_4V_02", "value": round(v2_wib, 3), "status": v2_status},
        {"item_id": "T03_4V_03", "value": round(c2_wib, 3), "status": total_c_status}
    ])
...
for i in range(4):
    femb = i
    tcp.femb_pwr_set(femb=i, pwr_on=1, v_fe=set_v, v_cd=set_v, v_adc=set_v, v_N=set_v)
    time.sleep(1)
    # print('debug')
